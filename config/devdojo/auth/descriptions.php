...
return [
    'settings' => [
        'dev' => 'This is for development mode, when set in Dev Mode Assets will be loaded from Vite', // image, svg
        'branding' => 'This will toggle on/off the Auth branding at the bottom of each auth screen. Consider leaving on to support and help grow this project.',
