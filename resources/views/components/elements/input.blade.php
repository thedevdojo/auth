        ...
        <div class="flex relative">
            @if($label)
                <label 
                    ...
                    :class="{ 'top-0 -translate-y-1 ml-2 text-xs text-zinc-800' : focusedOrFilled, 'top-[16px] ml-2.5 text-[15px] text-gray-500' : !focusedOrFilled }"
