...
<body class="bg-zinc-950">
    ...
    @if(config('devdojo.auth.auth.branding') && !app()->isLocal())
        <a href="https://devdojo.com/auth" target="_blank" class="flex fixed bottom-0 left-1/2 z-30 justify-center items-center px-2 py-1.5 w-auto text-xs font-medium bg-gradient-to-br from-black to-black rounded-t-lg border -translate-x-1/2 cursor-pointer text-white/40 hover:text-white via-zinc-900 border-zinc-800 hover:from-zinc-800 hover:via-zinc-800 hover:to-zinc-800">
