            ...
            <div class="flex justify-between w-full h-full select-none text-neutral-900">
                ...
                <div class="relative h-full cursor-default">
                    ...
                    <div 
                        ...
                        class="absolute top-0 z-50 min-w-[8rem] text-neutral-800 rounded-md border border-neutral-200/70 bg-white mt-10 text-sm p-1 shadow-md w-60 -translate-x-0.5"
                        x-cloak>

                        <x-auth::setup.menu.item
                            href="/"
                            icon="key"
                            text="Login"
                        ></x-auth::setup.menu.item>
