    ...
    <div class="flex flex-col w-full h-full bg-white rounded-t-md">
        <div class="flex relative z-50 shrink-0 justify-center items-center w-full h-10 bg-white rounded-t-md border-b border-zinc-200">
            ...
            <div class="flex absolute right-0 items-center h-full">
                <a :href="previewPageActive.url" target="_blank" class="flex shrink-0 items-center px-2 py-1 mr-2 text-xs bg-white rounded-md border shadow-xs duration-200 ease-out text-zinc-500 hover:text-zinc-700 hover:border-zinc-200 group border-zinc-100">
                    <span>Preview in New Tab</span>
                    <x-phosphor-arrow-right-bold class="shrink-0 ml-1 w-3 h-3 duration-200 ease-out -rotate-45 group-hover:-translate-y-px group-hover:translate-x-px" />
                </a>
