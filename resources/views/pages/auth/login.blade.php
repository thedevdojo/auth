...
<x-auth::elements.container>
    ...
    @if(config('devdojo.auth.settings.social_providers_location') == 'top' && (config('devdojo.auth.settings.login_show_social_providers') || config('devdojo.auth.settings.enable_passkeys')))
        <x-auth::elements.social-providers
            :socialProviders="config('devdojo.auth.settings.login_show_social_providers') ? \Devdojo\Auth\Helper::activeProviders() : []"
            :passkey="!$showSocialProviderInfo"
        />
    @endif
