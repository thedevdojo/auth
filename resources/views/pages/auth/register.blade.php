...
<x-auth::layouts.app title="{{ config('devdojo.auth.language.register.page_title') }}">
    ...
    <x-auth::elements.container>
        ...
        <form wire:submit="register" class="space-y-5">
            ...
            <x-auth::elements.input :label="config('devdojo.auth.language.register.password_confirmation')" type="password" wire:model="password_confirmation" id="password_confirmation" data-auth="password_confirmation-input" required />
            @endif
