...
<section class="max-w-(--breakpoint-lg) px-4 mx-auto py-14">
    ...
    <div class="mb-10">
        ...
        <p class="text-sm text-left text-gray-600">Welcome to your authentication setup. Below you will find sections to
            help you configure and customize the auth in your application.</p>
    </div>
    <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
        ...
        <x-auth::setup.welcome-card link="auth/setup/passkeys" icon="fingerprint" title="Configure Passkeys"
                                    description="Enable passwordless sign-in with passkeys on your authentication screens."></x-auth::setup.welcome-card>
